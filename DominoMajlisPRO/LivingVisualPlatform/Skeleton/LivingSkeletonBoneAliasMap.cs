...
public static class LivingSkeletonBoneAliasMap
{
    private static readonly Dictionary<LivingSkeletonBoneRole, string[]> Aliases = new()
    {
        ...
        [LivingSkeletonBoneRole.Eye] = new[] { "eye", "eyes", "mocapguy eyes" },
        [LivingSkeletonBoneRole.LeftEye] = new[] { "lefteye", "left eye", "mixamorig:lefteye", "mocapguy lefteye" },
        [LivingSkeletonBoneRole.RightEye] = new[] { "righteye", "right eye", "mixamorig:righteye", "mocapguy righteye" },
        ...
        [LivingSkeletonBoneRole.LeftFinger] = new[] { "mixamorig:lefthandindex1", "mixamorig:lefthandmiddle1", "mixamorig:lefthandthumb1", "lefthandindex1", "lefthandmiddle1", "lefthandthumb1" },
        [LivingSkeletonBoneRole.RightFinger] = new[] { "mixamorig:righthandindex1", "mixamorig:righthandmiddle1", "mixamorig:righthandthumb1", "righthandindex1", "righthandmiddle1", "righthandthumb1" },
