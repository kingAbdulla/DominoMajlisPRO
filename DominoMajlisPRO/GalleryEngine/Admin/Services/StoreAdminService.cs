...
public static class StoreAdminService
{
    public static IReadOnlyList<StoreAdminSection> GetSections()
    {
        return new List<StoreAdminSection>
        {
            ...
            CreateSection("name-effects", "أسماء و إطارات الهوية", "تأثيرات وإطارات أسماء اللاعبين والفرق", "N", StoreCardTemplateType.ProductCard, 10),
            CreateSection("frames", "الإطارات", "إطارات هوية اللاعب", "▢", StoreCardTemplateType.ProductCard, 11),
