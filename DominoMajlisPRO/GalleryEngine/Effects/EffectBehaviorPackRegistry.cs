    ...
    public static EffectBehaviorDefinitionModel LionPack =>
        BuildDefinition(
            ...
            dna: new EffectVisualDnaRecord
            {
                ...
                SmokeDensity        = 0.0f,
                SmokeSpeed          = 0.0f,
                EyeGlow             = 0.45f,   // 2.5-F: eye/focus glint
                EyeBlinkInterval    = 3.5f,
                ReflectionStrength  = 0.40f,   // 2.5-F: eye glint + sheen
                HeatStrength        = 0.55f,   // 2.5-F: head-motion sheen
                HeatRadius          = 0.0f,
                SparkCount          = 0f,
                SparkLifetime       = 0f,
                PulseStrength       = 1.00f,
    ...
    public static EffectBehaviorDefinitionModel EaglePack =>
        BuildDefinition(
            ...
            dna: new EffectVisualDnaRecord
            {
                ...
                SmokeDensity        = 0.0f,
                SmokeSpeed          = 0.0f,
                EyeGlow             = 0.85f,   // 2.5-F: sharp eye flash
                EyeBlinkInterval    = 3.0f,
                ReflectionStrength  = 0.60f,   // 2.5-F: wing-side shimmer
                HeatStrength        = 0.0f,
                HeatRadius          = 0.0f,
                SparkCount          = 4f,      // 2.5-F: feather streak count
                SparkLifetime       = 0.8f,
                PulseStrength       = 0.50f,
                WingAmplitude       = 0.70f,
                HeadRotation        = 0.0f,
    ...
    public static EffectBehaviorDefinitionModel WolfPack =>
        BuildDefinition(
            ...
            dna: new EffectVisualDnaRecord
            {
                ...
                SmokeDensity        = 0.38f,
                SmokeSpeed          = 0.28f,
                EyeGlow             = 0.70f,   // 2.5-F: icy eye flash
                EyeBlinkInterval    = 4.5f,
                ReflectionStrength  = 0.50f,   // 2.5-F: icy glint + frost-wind ring
                HeatStrength        = 0.0f,
                HeatRadius          = 0.0f,
                SparkCount          = 0f,
                SparkLifetime       = 0f,
    ...
    public static EffectBehaviorDefinitionModel CrownPack =>
        BuildDefinition(
            ...
            dna: new EffectVisualDnaRecord
            {
                ...
                EyeGlow             = 0.0f,
                EyeBlinkInterval    = 0.0f,
                ReflectionStrength  = 0.70f,   // 2.5-F: sparkle twinkle + royal shine
                HeatStrength        = 0.0f,
                HeatRadius          = 0.0f,
                SparkCount          = 8f,
                SparkLifetime       = 1.2f,
