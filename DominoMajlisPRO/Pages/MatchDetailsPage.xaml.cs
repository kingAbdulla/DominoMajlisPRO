...
public partial class MatchDetailsPage : ContentPage
{
    ...
    async Task LoadMatchData()
    {
        ...
        var nameTypographies = await TeamNameTypographyResolver.ResolveManyAsync(
            new[] { match.Team1Id, match.Team2Id });
        // Team 1

        Team1NameLabel.Text =
            match.Team1Name;
        nameTypographies.TryGetValue(match.Team1Id, out var team1NameTypography);
      ...
      $"{team1.Player1} ({team1.Player1Id})";
        ...
        Team2NameLabel.Text =
            match.Team2Name;
        nameTypographies.TryGetValue(match.Team2Id, out var team2NameTypography);
        IdentityPlateBinder.Apply(
            Team2NameLabel,
            Team2NamePlate,
            match.Team2Name,
