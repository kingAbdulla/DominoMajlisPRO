...
public partial class PlayerProfilesPage : ContentPage
{
    ...
    async Task RefreshAccountAvatarAsync()
    {
        ...
        var effectSource =
            ToOptionalImageSource(identity.Effect?.PreviewImage);
        AccountAvatarEffectOverlay.Source = effectSource;
        AccountAvatarEffectOverlay.IsVisible = effectSource != null;
